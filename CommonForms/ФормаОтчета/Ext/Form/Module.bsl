...
Процедура А1БСП_УстановитьВидимостьДоступность(ПриСохраненииВарианта)
	// А1 - собираем заголовок из имени отчета и имени варианта. Только для отчетов А1.
	...
	Если ЗначениеЗаполнено(ОтчетНаименованиеТекущегоВарианта) Тогда
		Заголовок = НастройкиОтчета.Наименование + " - " + ОтчетНаименованиеТекущегоВарианта;
	Иначе
